...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Integer> symtbl, MyIList<Integer> ot, IStmt prg, MyIDictionary<Integer, FileTableData> ft, MyIDictionary<Integer, Integer> hp, MyIDictionary<Integer, Integer> lt, int id){
        exeStack = stk;
        symTable = symtbl;
        out = ot;
        originalProgram = prg;
