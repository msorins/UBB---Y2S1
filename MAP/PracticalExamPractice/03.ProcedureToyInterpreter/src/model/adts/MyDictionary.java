...
public class MyDictionary<K, V> implements MyIDictionary<K, V>, Cloneable {
    ...
    public MyDictionary(MyDictionary<K, V> other) {
        this.setData((HashMap<K, V>) other.getData().clone());
    }

    public Object clone() throws CloneNotSupportedException{
        MyIDictionary<K, V> newMyDict = new MyDictionary<K, V>();
        newMyDict.setData( (HashMap<K, V>) this.getData().clone() );
