...
public class FxView extends Application{
    ...
    private void populatePrograms() {
        ...
        IStmt ex12 = new CompStmt(
                new NewBarrierStmt("wait", new ConstExp(2)),
                new CompStmt(
                        ex12_fork1,
                        new CompStmt(
                                ex12_fork2,
                                new CompStmt(
                                        ex12_fork3,
                                        new PrintStmt(new ConstExp(4))
                                )
                        )
                )
        );

        IStmt ex13_fork1 = new ForkStmt(
                new CompStmt(
        ...
        IStmt ex13 = new CompStmt(
                ...
                new CompStmt(
                        ...
                        new CompStmt(
                                ...
                                new CompStmt(
                                        new NewBarrierStmt("cnt", new rHExp("v3")),
                                        new CompStmt(
                                                ex13_fork1,
                                                new CompStmt(
                                                        ex13_fork2,
        ...
        programs.add(ex12); programNames.add(ex12.toString());
        programs.add(ex13); programNames.add(ex13.toString());
    }
